...
A star-schema data model was built in Power BI, connecting one fact table (Sales) to five dimension tables and a separate Returns fact table, with 13 custom DAX measures driving a 4-page interactive dashboard.

---

## Dataset Information

- **Source:** Kaggle (Adventure Works sales sample dataset)
...
13 measures were written to support the dashboard, ranging from simple aggregations to explicit time-intelligence and iterator-based calculations:
...
![Customers Page](dashboard_screenshots/02_customers.png)

**3. Region** — Country-wise sales on an interactive map, region-wise sales bar chart

![Region Page](dashboard_screenshots/03_region.png)

**4. Products** — Sales by bike subcategory, sales by product color

![Products Page](dashboard_screenshots/04_products.png)
...
- `AdventureWorks.pbix` — Power BI project file 
